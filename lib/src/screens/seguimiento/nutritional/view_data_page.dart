...
class ViewDataPage extends StatefulWidget {
  ...
  ViewDataPage({required this.data,});
...
Widget buildDataTable() {
       ...
       primaryYAxis: const NumericAxis(labelStyle: TextStyle(color: Colors.white),),
        ...
        series: <CartesianSeries>[
          LineSeries<Map<String, dynamic>, String>(
            ...
            yValueMapper: (entry, _) => entry['valor'],
          )
        ],
  ...
  void fetchData() async {
    try {
     // if(widget.coleccion == "Registro-Corporal") _typeData = _typeData.toLowerCase();
      final response = await NutritionalService.getDataWithDynamicSorting(
        context,
        _coleccion,
        _orderBy,
        _orderByDirection,
        _typeData.toLowerCase(),
      );
