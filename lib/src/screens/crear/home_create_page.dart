...
Exercise pressInclinadoExercise = Exercise(
  ...
  description: "El press inclinado es un ejercicio de levantamiento de peso que se realiza en un banco inclinado. Implica empujar una barra o mancuernas hacia arriba desde el pecho hasta que los brazos estén completamente extendidos, pero con un ángulo de inclinación del banco que pone más énfasis en la parte superior del pecho.",
  representativeImageLink: "https://ejemplo.com/imagen_press_inclinado.png",
  ...
  tags: ['Press inclinado', 'Pecho', 'Tríceps', 'Ejercicio de levantamiento de pesas'],
);
Exercise pressDeclinadoExercise = Exercise(
  name: "Press declinado",
  primaryFocus: "Pecho",
  secondaryFocus: "Tríceps",
  description: "El press declinado es un ejercicio de levantamiento de peso que se realiza en un banco declinado. Implica empujar una barra o mancuernas hacia arriba desde el pecho hasta que los brazos estén completamente extendidos, pero con un ángulo de declinación del banco que pone más énfasis en la parte inferior del pecho.",
  representativeImageLink: "https://ejemplo.com/imagen_press_declinado.png",
  videoLink: "https://ejemplo.com/video_press_declinado.mp4",
  focusLevels: {'Pecho': 3, 'Tríceps': 2, 'Hombro': 1},
  equipment: ['Barra', 'Mancuernas', 'Máquina Smith'],
  tags: ['Press declinado', 'Pecho', 'Tríceps', 'Ejercicio de levantamiento de pesas'],
);
...
Exercise pressPlanoExercise = Exercise(
  ...
  primaryFocus: "Pecho",
  secondaryFocus: "Tríceps",
  description: "El press plano es un ejercicio de levantamiento de peso que se realiza acostado en un banco horizontal. Implica empujar una barra o mancuernas hacia arriba desde el pecho hasta que los brazos estén completamente extendidos.",
  representativeImageLink: "https://ejemplo.com/imagen_press_plano.png",
  videoLink: "https://ejemplo.com/video_press_plano.mp4",
  focusLevels: {'Pecho': 3, 'Tríceps': 2, 'Hombro': 1},
  equipment: ['Barra', 'Mancuernas', 'Máquina Smith', 'Máquina de press de pecho'],
  tags: ['Press plano', 'Pecho', 'Tríceps', 'Ejercicio de levantamiento de pesas'],
);
...
Exercise fondosParalelasExercise = Exercise(
  ...
  primaryFocus: "Pecho",
  secondaryFocus: "Tríceps",
  description: "Los fondos en paralelas son un ejercicio de calistenia que se realiza con el propio peso corporal. Implica colgarse de barras paralelas y bajar el cuerpo hacia abajo flexionando los codos, luego se empuja hacia arriba hasta que los brazos estén completamente extendidos.",
  representativeImageLink: "https://ejemplo.com/imagen_fondos_paralelas.png",
  videoLink: "https://ejemplo.com/video_fondos_paralelas.mp4",
  focusLevels: {'Pecho': 3, 'Tríceps': 2, 'Hombro': 1},
  equipment: ['Barras paralelas'],
  tags: ['Fondos en paralelas', 'Pecho', 'Tríceps', 'Ejercicio de calistenia'],
);
...
Exercise aperturasMancuernasExercise = Exercise(
  ...
  tags: ['Aperturas con mancuernas', 'Pecho', 'Deltoides', 'Ejercicio de aislamiento'],
);
...
Exercise pulloverMancuernaExercise = Exercise(
  ...
  tags: ['Pull-over con mancuerna', 'Pecho', 'Espalda', 'Ejercicio compuesto'],
);
...
Exercise crucesPoleaMediaExercise = Exercise(
  ...
  representativeImageLink: "https://ejemplo.com/imagen_cruces_polea_media.png",
  videoLink: "https://ejemplo.com/video_cruces_polea_media.mp4",
  focusLevels: {'Pecho': 3, 'Deltoides': 2, 'Tríceps': 1},
  equipment: ['Aparato de polea con polea ajustada a posición media'],
  tags: ['Cruces en polea media', 'Pecho', 'Deltoides', 'Ejercicio de aislamiento'],
);
...
Exercise crucesPoleaBajaExercise = Exercise(
  ...
  primaryFocus: "Pecho",
  secondaryFocus: "Deltoides",
  description: "Los cruces en polea baja son un ejercicio de aislamiento para el pecho. Se realiza con una polea baja y un aparato de polea con dos mangos. Se coloca un pie adelante del otro y se jalan los mangos hacia arriba y hacia el frente cruzándolos frente al cuerpo hasta que los brazos estén extendidos.",
  representativeImageLink: "https://ejemplo.com/imagen_cruces_polea_baja.png",
  videoLink: "https://ejemplo.com/video_cruces_polea_baja.mp4",
  focusLevels: {'Pecho': 3, 'Deltoides': 2, 'Tríceps': 1},
  equipment: ['Aparato de polea con polea ajustada a posición baja'],
  tags: ['Cruces en polea baja', 'Pecho', 'Deltoides', 'Ejercicio de aislamiento'],
);
...
Exercise remoSentadoPoleaExercise = Exercise(
  ...
  description: "El remo sentado con polea es un ejercicio de fuerza que trabaja principalmente los músculos de la espalda y secundariamente los bíceps. Se realiza sentado en un banco con los pies apoyados en la plataforma y se jala la barra hacia el abdomen manteniendo la espalda recta y los codos cerca del cuerpo.",
  representativeImageLink: "https://ejemplo.com/imagen_remo_sentado_polea.png",
  ...
  tags: ['Remo sentado con polea', 'Espalda', 'Bíceps', 'Ejercicio de fuerza'],
);
...
Exercise remoPoleaSentadoExercise = Exercise(
  ...
  representativeImageLink: "https://ejemplo.com/imagen_remo_polea_sentado.png",
  videoLink: "https://ejemplo.com/video_remo_polea_sentado.mp4",
  focusLevels: {'Espalda': 3, 'Bíceps': 2, 'Trapecio': 1},
  equipment: ['Máquina de polea'],
  tags: ['Remo en polea sentado', 'Espalda', 'Bíceps', 'Ejercicio de fuerza'],
);
...
Exercise pressMilitarExercise = Exercise(
  ...
  secondaryFocus: "Tríceps",
  description: "El press militar es un ejercicio compuesto que se centra en desarrollar los músculos del hombro y los tríceps. Se realiza de pie o sentado, levantando una barra desde la parte superior del pecho hasta arriba de la cabeza, manteniendo los codos debajo de la barra en todo momento.",
...
Exercise elevacionesLateralesMancuernasExercise = Exercise(
  ...
  description: "Las elevaciones laterales con mancuernas son un ejercicio de aislamiento que se centra en trabajar los músculos deltoides laterales, que son parte de los hombros. Se realizan de pie, sosteniendo una mancuerna en cada mano y levantando los brazos hacia los lados hasta que estén paralelos al suelo, manteniendo una ligera flexión en los codos.",
  representativeImageLink: "https://ejemplo.com/imagen_elevaciones_laterales_mancuernas.png",
  videoLink: "https://ejemplo.com/video_elevaciones_laterales_mancuernas.mp4",
  focusLevels: {'Hombros': 3, 'Trapecio': 2, 'Deltoides posterior': 1},
  equipment: ['Mancuernas'],
  tags: ['Elevaciones laterales con mancuernas', 'Hombros', 'Trapecio', 'Ejercicio de aislamiento'],
);
...
Exercise facePullsExercise = Exercise(
  ...
  secondaryFocus: "Trapecio",
  description: "Los face pulls son un excelente ejercicio para trabajar los músculos del hombro, especialmente el deltoides posterior, así como el trapecio. Se realiza con una polea ajustada a la altura del rostro y se jala la cuerda hacia la cara, manteniendo los codos elevados y separados y los omóplatos retraídos.",
...
Exercise curlPredicadorExercise = Exercise(
  ...
  primaryFocus: "Bíceps",
  secondaryFocus: "Antebrazo",
  description: "El curl de predicador es un ejercicio de aislamiento que se centra en trabajar los músculos del bíceps. Se realiza en un banco de predicador, con los brazos apoyados sobre el cojín inclinado y las manos sosteniendo una barra o mancuerna. Se flexionan los codos para levantar el peso hacia los hombros, manteniendo los brazos apoyados sobre el banco en todo momento.",
  representativeImageLink: "https://ejemplo.com/imagen_curl_predicador.png",
  videoLink: "https://ejemplo.com/video_curl_predicador.mp4",
  focusLevels: {'Bíceps': 3, 'Antebrazo': 2, 'Hombros': 1},
  equipment: ['Banco de predicador', 'Barra', 'Mancuernas'],
  tags: ['Curl de predicador', 'Bíceps', 'Antebrazo', 'Ejercicio de aislamiento'],
);
...
Exercise curlMartilloMancuernasExercise = Exercise(
  ...
  primaryFocus: "Bíceps",
  secondaryFocus: "Antebrazo",
  description: "El curl de martillo con mancuernas es un ejercicio que se enfoca en desarrollar los músculos del bíceps y los antebrazos. Se realiza de pie, sosteniendo una mancuerna en cada mano con las palmas mirándose entre sí. Se flexionan los codos para levantar las mancuernas hacia los hombros, manteniendo las muñecas en posición neutra durante todo el movimiento.",
  representativeImageLink: "https://ejemplo.com/imagen_curl_martillo_mancuernas.png",
  videoLink: "https://ejemplo.com/video_curl_martillo_mancuernas.mp4",
  focusLevels: {'Bíceps': 3, 'Antebrazo': 2, 'Hombros': 1},
  equipment: ['Mancuernas'],
  tags: ['Curl de martillo con mancuernas', 'Bíceps', 'Antebrazo', 'Ejercicio de aislamiento'],
);
...
Exercise pressTricepsBarraRectaExercise = Exercise(
  ...
  tags: ['Press de tríceps con barra recta', 'Tríceps', 'Pecho', 'Ejercicio compuesto'],
);
...
Exercise curlMunecaBarraExercise = Exercise(
  ...
  secondaryFocus: "Bíceps",
  description: "El curl de muñeca con barra es un ejercicio que se centra en fortalecer los músculos del antebrazo, específicamente los flexores de la muñeca. Se realiza de pie, sosteniendo una barra con un agarre supino y dejando que la barra cuelgue frente al cuerpo. Luego, se flexionan las muñecas para levantar la barra hacia arriba y luego se baja controladamente.",
  representativeImageLink: "https://ejemplo.com/imagen_curl_muñeca_barra.png",
  videoLink: "https://ejemplo.com/video_curl_muñeca_barra.mp4",
  focusLevels: {'Antebrazo': 3, 'Bíceps': 2, 'Hombros': 1},
  equipment: ['Barra recta'],
  tags: ['Curl de muñeca con barra', 'Antebrazo', 'Bíceps', 'Ejercicio de aislamiento'],
);
...
Exercise curlMunecaMancuernaExercise = Exercise(
  ...
  primaryFocus: "Antebrazo",
  secondaryFocus: "Bíceps",
  description: "El curl de muñeca con mancuerna es un ejercicio que se enfoca en fortalecer los músculos del antebrazo, específicamente los flexores de la muñeca. Se realiza de pie, sosteniendo una mancuerna en una mano con un agarre supino y dejando que la mancuerna cuelgue frente al cuerpo. Luego, se flexionan las muñecas para levantar la mancuerna hacia arriba y luego se baja controladamente.",
  representativeImageLink: "https://ejemplo.com/imagen_curl_muñeca_mancuerna.png",
  videoLink: "https://ejemplo.com/video_curl_muñeca_mancuerna.mp4",
  focusLevels: {'Antebrazo': 3, 'Bíceps': 2, 'Hombros': 1},
  equipment: ['Mancuerna'],
  tags: ['Curl de muñeca con mancuerna', 'Antebrazo', 'Bíceps', 'Ejercicio de aislamiento'],
);
...
Exercise elevacionMunecaPronacionBarraExercise = Exercise(
  ...
  primaryFocus: "Antebrazo",
  secondaryFocus: "Bíceps",
  description: "La elevación de muñeca en pronación con barra es un ejercicio que se centra en fortalecer los músculos del antebrazo, especialmente los flexores de la muñeca y los músculos del bíceps. Se realiza de pie, sosteniendo una barra con un agarre pronado (palmas hacia abajo). Se elevan las muñecas hacia arriba y luego se bajan controladamente.",
  representativeImageLink: "https://ejemplo.com/imagen_elevacion_muñeca_pronacion_barra.png",
  videoLink: "https://ejemplo.com/video_elevacion_muñeca_pronacion_barra.mp4",
  focusLevels: {'Antebrazo': 3, 'Bíceps': 2, 'Hombros': 1},
  equipment: ['Barra recta'],
  tags: ['Elevación de muñeca en pronación con barra', 'Antebrazo', 'Bíceps', 'Ejercicio de aislamiento'],
);
...
Exercise elevacionMunecaSupinacionBarraExercise = Exercise(
  ...
  primaryFocus: "Antebrazo",
  secondaryFocus: "Bíceps",
  description: "La elevación de muñeca en supinación con barra es un ejercicio que se centra en fortalecer los músculos del antebrazo, especialmente los extensores de la muñeca y los músculos del bíceps. Se realiza de pie, sosteniendo una barra con un agarre supino (palmas hacia arriba). Se elevan las muñecas hacia arriba y luego se bajan controladamente.",
  representativeImageLink: "https://ejemplo.com/imagen_elevacion_muñeca_supinacion_barra.png",
  videoLink: "https://ejemplo.com/video_elevacion_muñeca_supinacion_barra.mp4",
  focusLevels: {'Antebrazo': 3, 'Bíceps': 2, 'Hombros': 1},
  equipment: ['Barra recta'],
  tags: ['Elevación de muñeca en supinación con barra', 'Antebrazo', 'Bíceps', 'Ejercicio de aislamiento'],
);
...
Exercise extensionesCuadricepsMaquinaExercise = Exercise(
  ...
  secondaryFocus: "Femoral",
  description: "Las extensiones de cuádriceps en máquina son un ejercicio efectivo para aislar y fortalecer los músculos del cuádriceps. Se realiza sentado en una máquina de extensión de piernas con los pies debajo de las almohadillas. Se extienden las piernas hacia adelante, manteniendo la espalda pegada al respaldo y controlando el movimiento en todo momento.",
  representativeImageLink: "https://ejemplo.com/imagen_extensiones_cuadriceps_maquina.png",
  videoLink: "https://ejemplo.com/video_extensiones_cuadriceps_maquina.mp4",
  focusLevels: {'Cuádriceps': 3, 'Femoral': 2, 'Glúteos': 1},
  equipment: ['Máquina de extensión de piernas'],
  tags: ['Extensiones de cuádriceps en máquina', 'Cuádriceps', 'Femoral', 'Ejercicio de aislamiento'],
);
...
Exercise prensaPiernasExercise = Exercise(
  ...
  description: "La prensa de piernas es un ejercicio excelente para trabajar los músculos de las piernas, en especial los cuádriceps y los glúteos. Se realiza en una máquina de prensa de piernas, donde se empuja un peso hacia arriba con los pies mientras se mantienen las piernas flexionadas.",
  representativeImageLink: "https://ejemplo.com/imagen_prensa_piernas.png",
  ...
  tags: ['Prensa de piernas', 'Cuádriceps', 'Glúteos', 'Ejercicio compuesto'],
);
...
Exercise zancadasExercise = Exercise(
  ...
  primaryFocus: "Cuádriceps",
  secondaryFocus: "Glúteos",
  description: "Las zancadas son un ejercicio efectivo para trabajar los músculos de las piernas, incluyendo los cuádriceps y los glúteos. Se realizan dando un paso hacia adelante con una pierna y bajando el cuerpo hasta que ambas rodillas estén dobladas en un ángulo de 90 grados, luego se vuelve a la posición inicial.",
...
Exercise sentadillaHackExercise = Exercise(
  ...
  primaryFocus: "Cuádriceps",
  secondaryFocus: "Glúteos",
  description: "La sentadilla hack es un ejercicio que se enfoca en los cuádriceps y los glúteos. Se realiza en una máquina de sentadilla hack, donde el cuerpo se desplaza hacia abajo y hacia arriba manteniendo los pies en una posición fija en una plataforma.",
  representativeImageLink: "https://ejemplo.com/imagen_sentadilla_hack.png",
  videoLink: "https://ejemplo.com/video_sentadilla_hack.mp4",
  focusLevels: {'Cuádriceps': 3, 'Glúteos': 2, 'Femoral': 1},
  equipment: ['Máquina de sentadilla hack'],
  tags: ['Sentadilla hack', 'Cuádriceps', 'Glúteos', 'Ejercicio compuesto'],
);
...
Exercise extensionesCuadricepsUnaPiernaExercise = Exercise(
  ...
  primaryFocus: "Cuádriceps",
  secondaryFocus: "Femoral",
  description: "Las extensiones de cuádriceps con una pierna son un ejercicio que se centra en fortalecer los cuádriceps de manera unilateral. Se realiza en una máquina de extensión de piernas ajustando el apoyo para que solo una pierna realice el movimiento de extensión.",
  representativeImageLink: "https://ejemplo.com/imagen_extensiones_cuadriceps_una_pierna.png",
  videoLink: "https://ejemplo.com/video_extensiones_cuadriceps_una_pierna.mp4",
  focusLevels: {'Cuádriceps': 3, 'Femoral': 2, 'Glúteos': 1},
  equipment: ['Máquina de extensión de piernas'],
  tags: ['Extensiones de cuádriceps con una pierna', 'Cuádriceps', 'Femoral', 'Ejercicio de aislamiento'],
);
...
Exercise pesoMuertoRumanoExercise = Exercise(
  ...
  representativeImageLink: "https://ejemplo.com/imagen_peso_muerto_rumano.png",
  videoLink: "https://ejemplo.com/video_peso_muerto_rumano.mp4",
  focusLevels: {'Femoral': 3, 'Glúteos': 2, 'Espalda baja': 1},
  equipment: ['Barra'],
  tags: ['Peso muerto rumano', 'Femoral', 'Glúteos', 'Ejercicio compuesto'],
);
...
Exercise curlFemoralMaquinaExercise = Exercise(
  ...
  primaryFocus: "Femoral",
  secondaryFocus: "Glúteos",
  description: "El curl femoral en máquina es un ejercicio que se centra en fortalecer los músculos isquiotibiales. Se realiza acostado en una máquina específica para curl femoral, flexionando las piernas desde las rodillas hacia los glúteos y luego bajando controladamente.",
  representativeImageLink: "https://ejemplo.com/imagen_curl_femoral_maquina.png",
  ...
  tags: ['Curl femoral en máquina', 'Femoral', 'Glúteos', 'Ejercicio de aislamiento'],
);
...
Exercise pesoMuertoConvencionalExercise = Exercise(
  ...
  primaryFocus: "Femoral",
  secondaryFocus: "Glúteos",
  description: "El peso muerto convencional es uno de los ejercicios más efectivos para fortalecer la cadena posterior, incluyendo los isquiotibiales y los glúteos, así como también involucra otros grupos musculares como la espalda baja y los músculos del core. Se realiza levantando una barra desde el suelo hasta la cadera, manteniendo la espalda recta y los brazos extendidos.",
  representativeImageLink: "https://ejemplo.com/imagen_peso_muerto_convencional.png",
  videoLink: "https://ejemplo.com/video_peso_muerto_convencional.mp4",
  focusLevels: {'Femoral': 3, 'Glúteos': 2, 'Espalda baja': 1},
  equipment: ['Barra'],
  tags: ['Peso muerto convencional', 'Femoral', 'Glúteos', 'Ejercicio compuesto'],
);
...
Exercise curlFemoralTumbadoExercise = Exercise(
  ...
  primaryFocus: "Femoral",
  secondaryFocus: "Glúteos",
  description: "El curl femoral tumbado es un ejercicio efectivo para fortalecer los isquiotibiales. Se realiza acostado boca abajo en una máquina específica para curl femoral, flexionando las piernas desde las rodillas hacia los glúteos y luego bajando controladamente.",
  representativeImageLink: "https://ejemplo.com/imagen_curl_femoral_tumbado.png",
  videoLink: "https://ejemplo.com/video_curl_femoral_tumbado.mp4",
  focusLevels: {'Femoral': 3, 'Glúteos': 2, 'Cuádriceps': 1},
  equipment: ['Máquina de curl femoral'],
  tags: ['Curl femoral tumbado', 'Femoral', 'Glúteos', 'Ejercicio de aislamiento'],
);
...
Exercise elevacionCaderaSueloExercise = Exercise(
  ...
  primaryFocus: "Glúteos",
  secondaryFocus: "Femoral",
  description: "La elevación de cadera en suelo es un ejercicio excelente para activar y fortalecer los glúteos. Se realiza acostado en el suelo con las rodillas flexionadas y los pies apoyados en el suelo. Se elevan las caderas hacia arriba, contrayendo los glúteos en la parte superior del movimiento.",
  representativeImageLink: "https://ejemplo.com/imagen_elevacion_cadera_suelo.png",
  videoLink: "https://ejemplo.com/video_elevacion_cadera_suelo.mp4",
  focusLevels: {'Glúteos': 3, 'Femoral': 2, 'Core': 1},
  equipment: [],
  tags: ['Elevación de cadera en suelo', 'Glúteos', 'Femoral', 'Ejercicio de aislamiento'],
);
...
Exercise prensaGluteosExercise = Exercise(
  ...
  description: "La prensa de glúteos es un ejercicio que se centra en fortalecer los músculos de los glúteos. Se realiza en una máquina específica para prensa de glúteos, donde se empuja un peso hacia atrás con los pies mientras se mantienen las rodillas flexionadas.",
  representativeImageLink: "https://ejemplo.com/imagen_prensa_gluteos.png",
  ...
  tags: ['Prensa de glúteos', 'Glúteos', 'Cuádriceps', 'Ejercicio compuesto'],
);
...
Exercise caminarCuclillasExercise = Exercise(
  ...
  primaryFocus: "Glúteos",
  secondaryFocus: "Cuádriceps",
  description: "Caminar en cuclillas es un ejercicio desafiante que involucra los glúteos y los cuádriceps. Se realiza caminando mientras se mantiene una posición de cuclillas, manteniendo la espalda recta y el peso en los talones.",
  representativeImageLink: "https://ejemplo.com/imagen_caminar_cuclillas.png",
  videoLink: "https://ejemplo.com/video_caminar_cuclillas.mp4",
  focusLevels: {'Glúteos': 3, 'Cuádriceps': 2, 'Femoral': 1},
  equipment: [],
  tags: ['Caminar en cuclillas', 'Glúteos', 'Cuádriceps', 'Ejercicio compuesto'],
);
...
Exercise gluteBridgeExercise = Exercise(
  ...
  primaryFocus: "Glúteos",
  secondaryFocus: "Femoral",
  description: "El Glute Bridge es un ejercicio efectivo para activar los glúteos y fortalecer la cadena posterior. Se realiza acostado boca arriba con las rodillas flexionadas y los pies apoyados en el suelo. Se elevan las caderas hacia arriba, manteniendo una línea recta desde los hombros hasta las rodillas.",
  representativeImageLink: "https://ejemplo.com/imagen_glute_bridge.png",
  videoLink: "https://ejemplo.com/video_glute_bridge.mp4",
  focusLevels: {'Glúteos': 3, 'Femoral': 2, 'Core': 1},
  equipment: [],
  tags: ['Glute bridge', 'Glúteos', 'Femoral', 'Ejercicio de aislamiento'],
);
...
Exercise elevacionTalonesPieBarraExercise = Exercise(
  ...
  secondaryFocus: "",
  description: "La elevación de talones de pie con barra es un ejercicio efectivo para fortalecer los músculos de los gemelos. Se realiza de pie con una barra sobre los hombros y los talones elevados, luego se baja los talones hacia el suelo y se vuelve a la posición inicial.",
  representativeImageLink: "https://ejemplo.com/imagen_elevacion_talones_pie_barra.png",
  videoLink: "https://ejemplo.com/video_elevacion_talones_pie_barra.mp4",
  focusLevels: {'Gemelos': 3, 'Antebrazo': 2},
  equipment: ['Barra'],
  tags: ['Elevación de talones de pie con barra', 'Gemelos', 'Ejercicio compuesto'],
);
...
Exercise elevacionTalonesPieMancuernasExercise = Exercise(
  ...
  primaryFocus: "Gemelos",
  secondaryFocus: "",
  description: "La elevación de talones de pie con mancuernas es un ejercicio que se enfoca en fortalecer los músculos de los gemelos. Se realiza de pie con mancuernas en las manos y los talones elevados, luego se baja los talones hacia el suelo y se vuelve a la posición inicial.",
  representativeImageLink: "https://ejemplo.com/imagen_elevacion_talones_pie_mancuernas.png",
  videoLink: "https://ejemplo.com/video_elevacion_talones_pie_mancuernas.mp4",
  focusLevels: {'Gemelos': 3, 'Antebrazo': 2},
  equipment: ['Mancuernas'],
  tags: ['Elevación de talones de pie con mancuernas', 'Gemelos', 'Ejercicio compuesto'],
);
...
Exercise elevacionTalonesMaquinaExercise = Exercise(
  ...
  primaryFocus: "Gemelos",
  secondaryFocus: "",
  description: "La elevación de talones en máquina es un ejercicio que se centra en fortalecer los músculos de los gemelos. Se realiza en una máquina específica para talones, donde se eleva los talones hacia arriba y luego se baja controladamente.",
  representativeImageLink: "https://ejemplo.com/imagen_elevacion_talones_maquina.png",
  videoLink: "https://ejemplo.com/video_elevacion_talones_maquina.mp4",
  focusLevels: {'Gemelos': 3, 'Antebrazo': 2},
  equipment: ['Máquina para elevación de talones'],
  tags: ['Elevación de talones en máquina', 'Gemelos', 'Ejercicio de aislamiento'],
);
...
Exercise elevacionTalonesSentadoExercise = Exercise(
  ...
  primaryFocus: "Gemelos",
  secondaryFocus: "",
  description: "La elevación de talones sentado es un ejercicio que se enfoca en fortalecer los músculos de los gemelos. Se realiza sentado en una máquina específica para talones, donde se eleva los talones hacia arriba y luego se baja controladamente.",
  representativeImageLink: "https://ejemplo.com/imagen_elevacion_talones_sentado.png",
  videoLink: "https://ejemplo.com/video_elevacion_talones_sentado.mp4",
  focusLevels: {'Gemelos': 3, 'Antebrazo': 2},
  equipment: ['Máquina para elevación de talones'],
  tags: ['Elevación de talones sentado', 'Gemelos', 'Ejercicio de aislamiento'],
);
...
Exercise crunchAbdominalExercise = Exercise(
  ...
  secondaryFocus: "Core",
  description: "El crunch abdominal es un ejercicio clásico para fortalecer los músculos del abdomen. Se realiza acostado boca arriba con las rodillas flexionadas y las manos detrás de la cabeza. Se eleva el torso hacia las rodillas, contrayendo los abdominales en la parte superior del movimiento.",
  representativeImageLink: "https://ejemplo.com/imagen_crunch_abdominal.png",
  videoLink: "https://ejemplo.com/video_crunch_abdominal.mp4",
  focusLevels: {'Abdomen': 3, 'Core': 2},
  equipment: [],
  tags: ['Crunch abdominal', 'Abdomen', 'Core', 'Ejercicio de aislamiento'],
);
...
Exercise planchaFrontalExercise = Exercise(
  ...
  primaryFocus: "Abdomen",
  secondaryFocus: "Core",
  description: "La plancha frontal es un ejercicio estático que fortalece los músculos del abdomen y del core. Se realiza apoyando el cuerpo en los antebrazos y los pies, manteniendo una posición recta desde la cabeza hasta los talones durante un período de tiempo determinado.",
  representativeImageLink: "https://ejemplo.com/imagen_plancha_frontal.png",
...
Exercise planchaLateralExercise = Exercise(
  ...
  primaryFocus: "Abdomen",
  secondaryFocus: "Core",
  description: "La plancha lateral es un ejercicio estático que fortalece los músculos del abdomen y del core, centrándose en los oblicuos. Se realiza apoyando el cuerpo de lado en un antebrazo y los pies, manteniendo una posición recta desde la cabeza hasta los pies durante un período de tiempo determinado.",
  representativeImageLink: "https://ejemplo.com/imagen_plancha_lateral.png",
...
Exercise elevacionPiernasColgadoExercise = Exercise(
  ...
  primaryFocus: "Abdomen",
  secondaryFocus: "Core",
  description: "La elevación de piernas colgado es un ejercicio avanzado que fortalece los músculos del abdomen y del core. Se realiza colgando de una barra con los brazos extendidos y elevando las piernas hacia arriba, manteniendo el control y evitando el balanceo del cuerpo.",
  representativeImageLink: "https://ejemplo.com/imagen_elevacion_piernas_colgado.png",
  videoLink: "https://ejemplo.com/video_elevacion_piernas_colgado.mp4",
  focusLevels: {'Abdomen': 3, 'Core': 2},
  equipment: ['Barra para dominadas'],
  tags: ['Elevación de piernas colgado', 'Abdomen', 'Core', 'Ejercicio avanzado'],
);
...
Exercise russianTwistPesoExercise = Exercise(
  ...
  description: "El Russian twist con peso es un ejercicio que fortalece los músculos del abdomen, especialmente los oblicuos. Se realiza sentado con las rodillas flexionadas y los pies apoyados en el suelo, sosteniendo un peso con las manos. Se gira el torso de lado a lado, tocando el suelo a cada lado.",
  representativeImageLink: "https://ejemplo.com/imagen_russian_twist_peso.png",
  videoLink: "https://ejemplo.com/video_russian_twist_peso.mp4",
  focusLevels: {'Abdomen': 3, 'Oblicuos': 2},
  equipment: ['Pesas'],
  tags: ['Russian twist con peso', 'Abdomen', 'Oblicuos', 'Ejercicio con peso'],
);
